...
export default function TermsPage() {
  return (
    <main className="max-w-2xl mx-auto py-16 px-4">
      ...
      <p className="mb-4 text-gray-700">Welcome to Gauras Organic Dairy! By using our website or app, you agree to the following terms and conditions. Please read them carefully.</p>
      ...
      <p className="mb-4 text-gray-700">Gauras Organic Dairy is not liable for any indirect or consequential damages arising from the use of our products or services.</p>
